/*
  ...
  Modified for rt-recon-sdk.
*/

#ifndef RT_RECON_SDK_INFLUXDB_CPP_HPP
#define RT_RECON_SDK_INFLUXDB_CPP_HPP
...
struct tag_caller : public builder {
  ...
  detail::field_caller& field(const std::string& k, double v, int prec = 5)
  {
...
#endif // RT_RECON_SDK_INFLUXDB_CPP_HPP
